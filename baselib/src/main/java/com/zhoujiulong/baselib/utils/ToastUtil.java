...
public class ToastUtil {
    ...
    public static void toast(String msg, int time) {
        if (mToast == null) {
            View v = LayoutInflater.from(ContextUtil.getContext()).inflate(R.layout.base_layout_toast, null);
    ...
    public static void showSuccess(String msg) {
        View v = LayoutInflater.from(ContextUtil.getContext()).inflate(R.layout.base_layout_state_toast, null);
